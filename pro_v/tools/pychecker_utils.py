...
def create_task_folder(base_dir: str, env_idx: int, rollout_idx: int, turn_idx: int) -> str:
    """
    ...
    Returns:
        Path to task folder
    """
    task_folder = os.path.join(base_dir, f"env_{env_idx}", f"rollout_{rollout_idx}", f"turn_{turn_idx}")
